...
def test_pattern_square_grid():
    ...
    gdf = regular_grid(dimension=(3, 3), resolution=1.0, attrs={"state": 0})
    pattern = [[1, 0], [0, 1]]
...
def test_pattern_nonsquare_grid():
    ...
    gdf = regular_grid(dimension=(3, 5), resolution=1.0, attrs={"state": 0})
    assert len(gdf) == 15
...
def test_pattern_out_of_bounds_ignored():
    ...
    gdf = regular_grid(dimension=(2, 2), resolution=1.0, attrs={"state": 0})
